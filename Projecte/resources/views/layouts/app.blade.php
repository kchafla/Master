    ...
    <body class="font-sans antialiased">
        @if (auth()->check())
            @if (Auth::user()->background != null)
                <div class="min-h-screen" style="background-image: url({{ asset('images/background/'.Auth::user()->background) }}); background-attachment: fixed; background-position: center; background-repeat: no-repeat; background-size: cover;">
            @else
